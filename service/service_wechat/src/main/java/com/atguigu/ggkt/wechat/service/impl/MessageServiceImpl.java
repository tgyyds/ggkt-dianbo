...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long id) {
        //微信openid
        String openid = "obU6s548QMAlXsjB7WH_Yw6skDIw";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)
                .templateId("BlQN8pV_fmRliO1aAIVuKux6MrpUnTXSNBZ0nGEiqzk")//模板id
                .url("http://tianggg.gnway.cc:8000/#/pay/"+id)
                .build();
        //如果是正式版发送消息，，这里需要配置你的信息
        templateMessage.addData(new WxMpTemplateData("first","亲爱的用户：您有一笔订单支付成功","#272727"));
        templateMessage.addData(new WxMpTemplateData("keyword1","13475578609","#272727"));
    ...
    private String subscribe(Map<String, String> param) {
        return this.text(param,"感谢你关注“硅谷课堂”，可以根据关键字搜索您想看的视频教程，如：JAVA基础、Spring boot、大数据等")
                .toString();
    }
