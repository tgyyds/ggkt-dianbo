...
public class CouresApiController {
    ...
    public Course getById(@ApiParam(value = "课程ID" , required = true)
    ...
    public Result findPageCourse(@ApiParam(value = "课程一级分类", required = true)
