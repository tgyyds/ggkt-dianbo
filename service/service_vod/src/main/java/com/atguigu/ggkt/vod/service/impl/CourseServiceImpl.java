...
public class CourseServiceImpl extends ServiceImpl<CourseMapper, Course> implements CourseService {
    ...
    public Map<String, Object> findPageCourse(Page<Course> pageParam,
        ...
        Long subjectId = courseQueryVo.getSubjectId();//第二层
        Long subjectParentId = courseQueryVo.getSubjectParentId();//第一层
    ...
    public Map<String, Object> getInfoById(Long courseId) {
        ...
        //课程所属讲师信息
        Teacher teacher = teacherService.getById(courseId);
    ...
    private Course getNameById(Course course) {
        //根据讲师id获取讲师名称
        Teacher teacher = teacherService.getById(course.getId());
        if(teacher != null) {
            String name = teacher.getName();
            course.getParam().put("name",name);
        }

        //根据课程分类id获取课程分类名称
        Subject subjectOne = subjectService.getById(course.getSubjectParentId());
        if(subjectOne!= null) {
            course.getParam().put("subjectParamTitle",subjectOne.getTitle());
        }
